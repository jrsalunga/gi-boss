...
sum(checks_pcs) as checks_pcs, sum(csh_out) as csh_out, sum(csh_outk) as csh_outk, sum(col_bdok) as col_bdok, sum(col_dink) as col_dink, sum(tot_disc) as tot_disc')) //count(id) as change_item
                ->whereBetween('date', 
