              ...
              <div class="row">
                ...
                <div class="col-md-8">
                    @if(count($d['timelogs'])>0)
                      ...
                      <span>
                        <span class="help label label-{{ $timelog->txnClass() }}" data-toggle="tooltip" title="{{ $timelog->getTxnCode() }} {{ $timelog->datetime->format('g:i:s A') }}">
                          {{ $timelog->datetime->format('g:i A') }}
                          @
                          {{ $timelog->branch->code or '' }}

                          <span class="help label label-{{ $timelog->entryClass() }}" data-toggle="tooltip" title="{{ $timelog->getEntry() }}">
                            {{ $timelog->getEntry() }}
                          </span>
                        </span>
