...
<div class="container-fluid">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/setslp/{{$setslp->lid()}}">{{ $setslp->fileUpload->filename }}</a></li>
    ...
    <div class="row">
        ...
        <div class="panel panel-success">
          ...
          <div class="panel-footer">
            ...
            @else
              ...
              <a href="/setslp/{{$setslp->lid()}}" class="btn btn-link">Cancel</a>
            @endif
          </div>
        </div><!-- end: .panel -->
        {!! Form::close() !!}
      ...
      <div class="col-md-6">
        ...
        @if(strtolower(pathinfo($setslp->filename, PATHINFO_EXTENSION))==='pdf')
          <iframe style="width: 100%; height: 500px;" src="/images/setslp/{{$setslp->lid()}}.{{strtolower(pathinfo($setslp->filename, PATHINFO_EXTENSION))}}"></iframe>
        @else
        <a href="{{$src}}" target="_blank">
          <img class="img-responsive" src="/images/setslp/{{$setslp->lid()}}.{{strtolower(pathinfo($setslp->filename, PATHINFO_EXTENSION))}}">
        </a>
        @endif
