...
<div style="background-color:#F8F9FA;font-size:14px;">
  <div style=";width:65%;margin-left:auto;margin-right: auto;margin-top:0px;margin-bottom:30px;">
    ...
    <div style="border: 1px solid #E8EAED;background-color:#fff;">
      ...
      <!-- <h2>Welcome</h2> -->
      <p style="padding:0;margin:0;margin-bottom:15px;line-height:24px;font-family:Roboto,Helvetica,Arial,sans-serif;">The export request transfer of employee <em><strong><a href="{{ $href }}" style="text-decoration: none; color: #000; cursor: pointer;">{{ $fullname }}</a></strong></em> was approved by the HR.</p>
