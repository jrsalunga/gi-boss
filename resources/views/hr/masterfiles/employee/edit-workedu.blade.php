...
@section('title', $employee->code .' - '.$employee->lastname.', '.$employee->firstname.' '.$employee->middlename .' - Employee Update Work & Education Info')
			...
			html += '<a class="list-group-item" tabindex="-10">';
			     html += '<div class="row">';
						 ...
						 html += '<div class="form-group">';
						    ...
						    html += '<div class="input-group monyr">';
						    html += '<input type="text" class="form-control" id="workexp['+idx+'][periodfrom]" name="workexp['+idx+'][periodfrom]" placeholder="YYYY-MM" maxlength="7" data-mask="0000-00">';
						...
						html += '<div class="col-md-2">';
						    ...
						    html += '<div class="input-group monyr">';
						    html += '<input type="text" class="form-control" id="workexp['+idx+'][periodto]" name="workexp['+idx+'][periodto]" placeholder="YYYY-MM" maxlength="7" data-mask="0000-00">';
						  html += '<div class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></div></div>';
						  html += '</div>';
						html += '</div><!-- end: .col-md-2 -->';
		...
		html += '<a class="list-group-item" tabindex="-10">';
			    html += '<div class="row">';
						html += '<div class="col-md-2">';
						    ...
						    html += '<div class="input-group monyr">';
						    html += '<input type="text" class="form-control" id="education['+idx+'][periodfrom]" name="education['+idx+'][periodfrom]" placeholder="YYYY-MM" maxlength="7" data-mask="0000-00">';
						     html += '<div class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></div></div>';
						  html += '</div>';
						html += '</div><!-- end: .col-md-2 -->';
						html += '<div class="col-md-2">';
						    ...
						    html += '<div class="input-group monyr">';
						    html += '<input type="text" class="form-control" id="education['+idx+'][periodto]" name="education['+idx+'][periodto]" placeholder="YYYY-MM" maxlength="7" data-mask="0000-00">';
						     html += '<div class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></div></div>';
						  html += '</div>';
						html += '</div><!-- end: .col-md-2 -->';
						html += '<div class="col-md-3">';
