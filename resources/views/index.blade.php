          ...
          <div class="text-right">
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu dropdown-menu-right">
                ...
                <li><a href="/report/customer/month?fr={{c()->startOfYear()->format('Y-m-d')}}&amp;to={{c()->lastOfMonth()->format('Y-m-d')}}">Customer Summary <small class="text-muted">(All Branch)</small>  <small><span class="label label-danger">new</span></small></a></li>
                <li><a href="/report/transaction/month?fr={{c()->startOfYear()->format('Y-m-d')}}&amp;to={{c()->lastOfMonth()->format('Y-m-d')}}">Transaction Summary <small class="text-muted">(All Branch)</small>  <small><span class="label label-danger">new</span></small></a></li>
