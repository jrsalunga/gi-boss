          ...
          <div class="text-right">
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu dropdown-menu-right">
                ...
                <li><a href="/report/transaction/month">Transaction Summary <small class="text-muted">(All Branch)</small>  <small><span class="label label-danger">new</span></small></a></li>
