...
@section('title', ' - Component Masterfiles')
      ...
      <div class="container-fluid">
        <div class="navbar-form">
          ...
          <div class="btn-group btn-group pull-right clearfix hidden-xs" role="group" style="margin-left: 5px;">
            {!! Form::open(['url' => '/masterfiles/component', 'method' => 'get', 'id'=>'filter-form']) !!}
    ...
    <div class="col-md-12">
      <div class="table-responsive">
        ...
        <tbody>
          ...
          <?php
            $component->load('compcat');
          ?>
          <tr>
            <td>{{ $component->code }}</td>
            <td>{{ $component->descriptor }}</td>
            <td class="text-right">{{ number_format($component->cost,2) }}</td>
            <td>{{ $component->uom }}</td>
            <td>{{ $component->compcat->descriptor or '' }}</td>
          </tr>
          @endforeach
        </tbody>
        </table>
