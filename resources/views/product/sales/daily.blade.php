...
<div class="container-fluid">
  ...
  @if($backups)
    <div class="alert alert-warning alert-important">
      ...
      Verify on <a class="btn btn-default" href="/backup/checklist?branchid={{$branch->lid()}}&date={{$backups[0]->format('Y-m-d')}}"><span class="fa fa-file-archive-o"></span> Backup Checklist</a>
      <ul>
                    ...
                    <div class="table-responsive">
                      <div>
                        <table class="tb-prodcat-data table table-condensed table-hover table-striped">
                          ...
                          <tfoot><tr><td></td><td class="text-right"><b>{{number_format($t,2)}}</b></td><td></td></tr></tfoot>
                        </table>
                      </div>
