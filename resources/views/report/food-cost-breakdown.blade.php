...
@section('title', '-  Monthly Food Cost Summary')

@section('body-class', 'monthly-fc-summary')
        ...
        <table class="table table-condensed table-hover table-striped table-sort" style="margin-top: 0;">
          <thead>
            <tr>
              ...
              <th class="text-right" style="width:17%;" title="Purchased - Transfered = Actual Used" data-toggle="tooltip">Actual Used</th>
